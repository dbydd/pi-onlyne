...
interface State { cwd: string; workspace: Workspace | null; watching: boolean; owner: "external" | "stopped"; child?: any; socket?: any; currentInbound?: { channelId: string; conversationId: string; messageId?: string; text: string; replied: boolean; noReply: boolean; reminders: number; fallbackText?: string }; lastValidOutput?: string }
